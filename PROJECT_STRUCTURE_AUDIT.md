...
| `components/intro-scene/` | — | The single R3F scene and the LNP1 codec. Was `components/particle-nav/` (36 files) until 2026-09-01, when the radial navigation it also carried was deleted and the directory was renamed | Every file has ≥1 importer | source-of-truth | Keep | **renamed, orbit layers deleted** | high |
...
| `graphics-task-02.md` | 2026 nav-layer spec | Already self-banner-marked HISTORICAL | archive-candidate | Archive | **moved**, then deleted 2026-09-01 with the radial navigation |
