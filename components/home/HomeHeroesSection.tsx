...
export function HomeHeroesSection({section}:{section:HomepageEdition['heroes']}){
 return <section id="home-heroes" className={styles.section} aria-labelledby="home-heroes-title" data-home-section="heroes">
 <SectionHeading id="home-heroes-title" kicker="People, not statistics" title="Our Heroes" href="/our-heroes" action="Read Our Heroes"/>
