...
export function HomeHistorySection({section}:{section:HomepageEdition['israelsStory']}){
 return <section className={styles.section} aria-labelledby="home-history-title" data-home-section="israelsStory">
 ...
 </article>)}</div><SectionState section={section} cover="/images/homepage/covers/chapter.svg" href="/israels-story" action="Explore Israel’s Story"/></section>;
}
