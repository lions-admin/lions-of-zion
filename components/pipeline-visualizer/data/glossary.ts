...
export const PIPELINE_GLOSSARY: GlossaryTerm[] = [
  ...
  },
  {
    ...
    deepExplanationHe:
      "אם בריף יומי שנכתב ע\"י בינה מלאכותית נכשל אפילו באחת מתוך 18 בדיקות האיכות (למשל: ציטט מקור לא מאושר, או הפריך נרטיב בלי לסמן את ההפרכה כניתוח של הארגון), הוא מועבר מיידית לטבלת `briefing_quarantine` ונחסם מפרסום לציבור עד לסקירה אנושית.",
